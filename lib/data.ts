...
export const opportunities: Opportunity[] = [
  ...
  {
    id: 'op-13',
    title: 'Международная Жаутыковская олимпиада (IZhO / Impact)',
    organization: 'IZhO / Impact',
    category: 'STEM',
    format: 'Гибридный',
    deadline: '2026-01-10',
    description:
      'Международная олимпиада по математике, физике и информатике для школьников Центральной Азии.',
    requirements: ['8–11 класс', 'Заявка/отбор'],
    grades: ['8', '9', '10', '11'],
    tags: ['Математика', 'Физика', 'Информатика', 'Олимпиада'],
    link: 'https://izho.kz',
    logo: 'Ж',
  },
  {
    id: 'op-14',
    title: 'Пифагоровская олимпиада',
    organization: 'IQ College / Школа Пифагор',
    category: 'STEM',
    format: 'Гибридный',
    deadline: '2026-04-15',
    description: 'Популярная математическая олимпиада для младших и средних классов (туры онлайн/офлайн).',
    requirements: ['3–8 класс'],
    grades: ['7', '8'],
    tags: ['Математика', 'Олимпиада'],
    link: 'https://iqcollege.kz',
    logo: 'П',
  },
  {
    id: 'op-15',
    title: 'Иранская олимпиада по геометрии (IGO)',
    organization: 'ЦОП «Аль-Фараби» / matol.kz',
    category: 'STEM',
    format: 'Гибридный',
    deadline: '2026-10-15',
    description: 'Международная олимпиада по геометрии высокого уровня для школьников.',
    requirements: ['7–12 класс'],
    grades: ['7', '8', '9', '10', '11'],
    tags: ['Геометрия', 'Математика', 'Международная'],
    link: 'https://matol.kz',
    logo: 'И',
  },
  {
    id: 'op-16',
    title: 'Устная олимпиада по геометрии памяти И.Ф. Шарыгина',
    organization: 'matol.kz / fizmat.kz',
    category: 'STEM',
    format: 'Офлайн',
    deadline: '2026-04-15',
    description:
      'Классическая устная олимпиада по геометрии: участники решают и устно представляют решения жюри. Очные этапы в нескольких городах.',
    requirements: ['8–11 класс'],
    grades: ['8', '9', '10', '11'],
    tags: ['Геометрия', 'Устная', 'Олимпиада'],
    link: 'https://matol.kz',
    logo: 'Ш',
  },
  {
    id: 'op-17',
    title: 'Юниорская олимпиада по математике',
    organization: 'РНПЦ «Дарын» / matol.kz',
    category: 'STEM',
    format: 'Офлайн',
    deadline: '2026-05-01',
    description: 'Многоэтапная республиканская олимпиада для младших и средних классов (районные, областные и республиканский этапы).',
    requirements: ['5–8 класс'],
    grades: ['5', '6', '7', '8'],
    tags: ['Математика', 'Юниоры', 'Республика'],
    link: 'https://daryn.kz',
    logo: 'Д',
  },
  {
    ...
    organization: 'РНПЦ «Дарын» (отбор)',
    category: 'STEM',
    format: 'Офлайн',
    deadline: '2026-07-01',
    description: 'Международная финальная олимпиада по математике. Отбор участников через национальную систему Дарын.',
    requirements: ['9–11 класс', 'Отбор'],
    grades: ['9', '10', '11'],
    tags: ['Математика', 'Международная', 'IMO'],
    link: 'https://daryn.kz',
    logo: 'I',
  },
  {
    id: 'op-19',
    title: 'Республиканская олимпиада «Дарын» по учебным предметам',
    organization: 'РНПЦ «Дарын»',
    category: 'STEM',
    format: 'Офлайн',
    deadline: '2025-09-01',
    description:
      'Многопредметная республиканская олимпиада (школьный → районный/городской → областной → республиканский этапы).',
    requirements: ['9–11 класс'],
    grades: ['9', '10', '11'],
    tags: ['Многопредметная', 'Республика', 'Олимпиада'],
    link: 'https://daryn.kz',
    logo: 'Д',
  },
  {
    id: 'op-20',
    title: 'Prompt Play Hackathon',
    organization: 'Astana IT University (AITU)',
    category: 'Программирование',
    format: 'Гибридный',
    deadline: '2027-05-01',
    description:
      'Хакатон по AI, prompt engineering и game development — международный формат, финал в AITU; следите за анонсами.',
    requirements: ['Старшеклассники и студенты'],
    grades: ['10', '11', 'Студент'],
    tags: ['AI', 'Prompt', 'Хакатон'],
    link: 'https://prompt2026.astanait.edu.kz',
    logo: 'A',
  },
  {
    id: 'op-21',
    title: "HackNU'26 / HackNU (Nazarbayev University)",
    organization: 'Nazarbayev University',
    category: 'Программирование',
    format: 'Офлайн',
    deadline: '2027-04-01',
    description: '24-часовой оффлайн-хакатон с фокусом на AI/ML и software engineering.',
    requirements: ['Старшеклассники и студенты'],
    grades: ['9', '10', '11', 'Студент'],
    tags: ['Хакатон', 'AI', 'ML'],
    link: 'https://hacknu.nuacm.kz',
    logo: 'N',
  },
  {
    id: 'op-22',
    title: 'UNICEF Жастары — Youth Volunteer Program',
    ...
    grades: ['9', '10', '11', 'Студент'],
    tags: ['Волонтёрство', 'Социальное влияние', 'Образование'],
    link: 'https://unicefzhastary.kz',
    logo: 'U',
  },
  {
    id: 'op-23',
    title: 'FLEX — Future Leaders Exchange Program',
    ...
    grades: ['8', '9', '10'],
    tags: ['Обмен', 'Лидерство', 'Английский'],
    link: 'https://kazakhstan.americancouncils.org/flex',
    logo: 'F',
  },
]
